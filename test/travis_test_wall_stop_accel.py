...
class WallStopTest(unittest.TestCase):
	...
	def test_io(self):
		...
		self.assertTrue(0 < left == right < 1000, "can't move agein")

		time.sleep(5.0)
		left, right =self.set_and_get(40, 0, 0, 9)
		self.assertTrue(2000 < left == right, "cant accerelate")


		left, right = self.set_and_get(15, 0, 20, 15) #total: 500
		self.assertTrue(left == right == 0, "can,t stop agein")
